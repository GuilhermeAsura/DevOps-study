    ...
    stages {
        ...
        stage('Build Images') {
            steps {
                script {
                    // Nome das imagens
                    def imageNameWeb = 'guilhermelazzarini/web'
                    def imageNameDB = 'guilhermelazzarini/db'
                    def imageNameNginx = 'guilhermelazzarini/nginx'

                    // Executa o build das imagens com os respectivos Dockerfiles
                    docker.withRegistry('https://registry.hub.docker.com', 'dockerhubguilherme') {
